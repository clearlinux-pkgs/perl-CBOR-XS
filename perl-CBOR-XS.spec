...
Version  : 1.82
Release  : 6
URL      : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/CBOR-XS-1.82.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/CBOR-XS-1.82.tar.gz
Summary  : unknown
...
%prep
%setup -q -n CBOR-XS-1.82
cd %{_builddir}/CBOR-XS-1.82
...
cp %{_builddir}/CBOR-XS-1.82/COPYING %{buildroot}/usr/share/package-licenses/perl-CBOR-XS/8624bcdae55baeef00cd11d5dfcfa60f68710a02
if test -f Makefile.PL; then
