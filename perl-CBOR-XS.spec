...
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/CBOR-XS-1.71.tar.gz
Summary  : unknown
...
%prep
%setup -q -n CBOR-XS-1.71
cd %{_builddir}/CBOR-XS-1.71
...
cp %{_builddir}/CBOR-XS-1.71/COPYING %{buildroot}/usr/share/package-licenses/perl-CBOR-XS/8624bcdae55baeef00cd11d5dfcfa60f68710a02
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/x86_64-linux-thread-multi/CBOR/XS.pm
/usr/lib/perl5/vendor_perl/5.30.2/x86_64-linux-thread-multi/auto/CBOR/XS/XS.so
