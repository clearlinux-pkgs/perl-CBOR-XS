...
Source0  : https://cpan.metacpan.org/authors/id/M/ML/MLEHMANN/CBOR-XS-1.84.tar.gz
Summary  : unknown
...
%prep
%setup -q -n CBOR-XS-1.84
cd %{_builddir}/CBOR-XS-1.84
...
cp %{_builddir}/CBOR-XS-1.84/COPYING %{buildroot}/usr/share/package-licenses/perl-CBOR-XS/8624bcdae55baeef00cd11d5dfcfa60f68710a02
if test -f Makefile.PL; then
